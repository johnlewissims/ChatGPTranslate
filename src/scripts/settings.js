...
document.addEventListener('DOMContentLoaded', () => {
    ...
    chrome.storage.local.get(
        ...
        function (result) {
            ...
            document.getElementById('always-display-explanation').checked =
                !!result.alwaysDisplayExplanation;
            document.getElementById('get-translation-as-html').checked =
                !!result.getTranslationAsHtml;
            ...
            document.getElementById('display-tokens').checked =
    ...
    document
        ...
        .addEventListener('submit', function (event) {
            ...
            const alwaysDisplayExplanation = document.getElementById(
                'always-display-explanation',
            ).checked;
            const getTranslationAsHtml = document.getElementById(
    ...
    document
        ...
        .addEventListener('input', updateGptModelAttributeDisabled);
    document
        .getElementById('load-all-gpt-models')
